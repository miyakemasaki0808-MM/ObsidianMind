...
| ID | 指摘 | 処遇 |
|---|---|---|
| `2026-09-02-bearing-fix-review/P3-1` | WCAG 1.4.1を形による残数表現の禁止根拠として扱い、基準の適用範囲を誤っている | `統合` BOOK-2 |
| `2026-09-02-bearing-fix-review/P3-2` | 束の10枚すべてに縁を出す契約と、実機ケースの範囲／検証件数が同期していない | `統合` BOOK-2 |
| `2026-09-02-bearing-code-review/P2-2` | 形の走査テストがimportや未到達の関数だけで成功し、役割代入と縁の配線を固定していない | `統合` BOOK-2 |
