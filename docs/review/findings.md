...
| ID | 指摘 | 処遇 |
|---|---|---|
| `2026-08-29-x11-code-review/P2-1` | 同じプリセットの再タップで重なり解消の理由だけが消える | `統合` BOLD-2 |
| `2026-08-29-x11-code-review/P2-2` | 外された候補のシートで、その候補自身を「ほか」と誤って説明する | `統合` BOLD-2 |
| `2026-08-29-x11-code-review/P2-3` | UIテストが確定範囲の太字と下線を実際には検査していない | `統合` BOLD-2 |
| `2026-08-29-x11-code-review/P3-1` | 索引と親機能文書が段階1を未実装と案内している | `統合` BOLD-2 |
