...
| ID | 指摘 | 処遇 |
|---|---|---|
| `2026-08-26-x9-code-review/P1-1` | 端末側痕跡の一時的な読取失敗が不在へ畳まれ、返事を警告なしで上書きし得る | `統合` TRACE-4 |
| `2026-08-26-x9-code-review/P1-2` | 下見後の端末側変更を再確認せず、表示していない返事損失を確定できる | `統合` TRACE-4 |
| `2026-08-26-x9-code-review/P2-1` | 返事損失の下見文言と実機ケースが新しい側を残すマージ規則と逆になる | `統合` TRACE-4 |
| `2026-08-26-x9-code-review/P2-2` | 最大8MB・5000件の退避JSON組み立てと解析がMain上で走る | `起票` PERF-2 |
