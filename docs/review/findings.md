...
| ID | 指摘 | 処遇 |
|---|---|---|
| `2026-08-30-booklet-refix-review/P1-1` | 停止中に始まった新しい読書Sessionが背面時間を計測する | `統合` BOOK-1 |
| `2026-08-30-booklet-refix-review/P2-1` | Back取消テストが本番Jobの登録と全副作用を通っていない | `統合` BOOK-1 |
| `2026-08-30-booklet-refix-review/P3-1` | 実機ケースIDが重複し描画テスト件数も古い | `統合` BOOK-1 |
| `2026-08-30-booklet-refix-review/P3-2` | 正本の検証表が引用で中断され実機行が表の外へ出ている | `統合` BOOK-1 |
