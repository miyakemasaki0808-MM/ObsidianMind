...
| ID | 指摘 | 処遇 |
|---|---|---|
| `2026-09-13-backup-exclusion-fix-review/P2-1` | 同一ファイル内の同名定数を誤解決し、新しい保存先の除外漏れを見逃す | `統合` TEST-1 |
| `2026-09-13-backup-exclusion-fix-review/P2-2` | .xmlを欠く別パスを正しいprefs除外として受理する | `統合` TEST-1 |
| `2026-09-12-fable51-privacy-fix-review/P2-1` | 同名定数があると、新しい保存先の除外漏れを見逃す | `起票` TEST-1 |
