...
| ID | 指摘 | 処遇 |
|---|---|---|
| `2026-08-30-booklet-fix-review/P1-1` | 冊子表示中の背面復帰が読書時間の計測を再開する | `統合` BOOK-1 |
| `2026-08-30-booklet-fix-review/P2-1` | フェンス閉じ行の末尾を検査せずコード内容を扉へ漏らす | `統合` BOOK-1 |
| `2026-08-30-booklet-fix-review/P2-2` | routeテストが呼出文字列しか見ずBack取消と先頭復帰を保証しない | `統合` BOOK-1 |
| `2026-08-30-booklet-fix-review/P3-1` | 正本の最終検証が修正前HEAD＋未コミット差分のまま | `統合` BOOK-1 |
