...
| ID | 指摘 | 処遇 |
|---|---|---|
| `2026-08-22-x5-code-review/P2-1` | 読書痕跡の有効な長い履歴を共通クランプが行途中で切り、最新訪問の到達率を失う | `統合` AI-3 |
| `2026-08-22-x5-code-review/P2-2` | AIピッカーが予算で提示から落としたタイトルを応答側では受理する | `統合` AI-4 |
| `2026-08-22-x5-code-review/P3-1` | AI入力予算の実機ケースがレビュー入口と存在検査へ未登録 | `統合` AI-3 |
