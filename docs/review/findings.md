...
| ID | 指摘 | 処遇 |
|---|---|---|
| `2026-09-06-book7-code-review/P2-1` | 本番の表・裏の切り抜きを片側だけ無効にしても、めくりの検査が通る | `統合` BOOK-7 |
| `2026-09-06-book7-code-review/P3-1` | 角めくりへ変更後も実機の合否条件と残作業に半回転・旧速度・帯の調整が残る | `統合` BOOK-7 |
| `2026-09-05-book6-sign-external-device-review/P3-1` | 静止紙の幅一致テストが下端の縮小を検出しない | `統合` BOOK-6 |
