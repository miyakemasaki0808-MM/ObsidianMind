...
| ID | 指摘 | 処遇 |
|---|---|---|
| `2026-09-06-book7-fix-review/P3-1` | 正本の検証一覧が削除済みの真横での表裏切替を現行JVM保証として残す | `統合` BOOK-7 |
| `2026-09-06-book7-code-review/P3-1` | 旧方式の同期は部分解消、正本の検証一覧に真横での表裏切替が残る | `統合` BOOK-7 |
