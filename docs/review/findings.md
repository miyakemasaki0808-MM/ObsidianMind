...
| ID | 指摘 | 処遇 |
|---|---|---|
| `2026-08-21-x4-fix-review/P2-1` | 世代つき寸法LRUを複数のIOコルーチンが同期なしで読み書きする | `統合` IMG-2 |
| `2026-08-21-x4-fix-review/P2-2` | 旧測定値があると、世代の再確認より先にBitmapの読み込みを始める | `統合` IMG-2 |
| `2026-08-21-x4-fix-review/P2-3` | 測定失敗を共有すると、その参照は以後の再確認対象から外れる | `統合` IMG-2 |
| `2026-08-21-x4-code-review/P2-1` | 上書き後の新Bitmapが、参照文字列だけで残る旧測定値の縦横比へ描かれる | `統合` IMG-2 |
