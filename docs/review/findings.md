...
| ID | 指摘 | 処遇 |
|---|---|---|
| `2026-08-26-x9-fix-review/P1-1` | 中止結果の表示後も読み戻しが続き、表示件数より多く保存される | `統合` TRACE-4 |
| `2026-08-26-x9-fix-review/P3-1` | 退避JSONに `documentId` のキー自体がnullで残る | `起票` TRACE-5 |
| `2026-08-26-x9-fix-review/P3-2` | 非退避Markdownだけ正本と異なるエラー文言になる | `起票` TRACE-5 |
