...
| `2026-09-12-fable51-privacy-fix-review/P2-2` | コメントアウトした除外設定も有効と判定する | `起票` TEST-1 |
| `2026-09-12-fable51-privacy-fix-review/P3-1` | 旧版との権限差の説明が準備手順と `PERM-01` で食い違う | `起票` DOC-2 |
