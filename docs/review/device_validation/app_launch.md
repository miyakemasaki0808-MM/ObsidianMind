...
| `LAUNCH-05` | ノートを表示した状態で端末を回転させ、Foldがあれば開閉する。**手順は [app_launch_recreation](app_launch_recreation.md)** | OPが出ず、`MainActivity` が1枚のまま残る。`LAUNCH-05a`〜`05e` がすべて合格したときだけ合格 |
