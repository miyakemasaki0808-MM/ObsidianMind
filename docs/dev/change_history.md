...
| 2026-09-18 | — | 要約キャッシュの実機7ケースの成功と混雑時文言の未観測を記録し、設計・検討枠の確認状況を同期した | [review](../review/README.md) |
| 2026-09-17 | — | 要約キャッシュのレビュー2巡に対応し、要約の生成をDebug APKのログで数え、再起動の試行は起動前から数える実機判定にした | [note_summary](features/note_summary.md) §10 |
| 2026-09-17 | — | 要約を完成したプロンプトを鍵に端末へ保存して開き直しでは生成せず、AICoreの回数制限は英文でなく開き直しを促す文言にした | [note_summary](features/note_summary.md) 判断6〜9 |
| 2026-09-17 | — | 回転・Fold開閉の実機ケースを、ユーザーの操作と同一プロセスの監視でOPとガードを見る手順書に分けた | [opening_animation](features/opening_animation.md) §10 |
| 2026-09-16 | — | AIピッカーの候補をIDで提示してIDだけ受理し、タイトルの言い換えや翻訳で候補が黙って落ちないようにした | [ai_picker](features/ai_picker.md) 判断6 |
| 2026-09-16 | — | 経緯の検査で、前回P1・レビューのP2のようにレビューの文脈と並んだ枝番の無い指摘番号も落とすようにした | — |
| 2026-09-16 | — | コメント行数の上位ファイルのうち分割で扱わなかった8本から経緯を落とし、今の実装と食い違う説明と切れた参照を直した | [architecture](system/architecture.md) 判断5 |
...
| 2026-09-13 | — | レビュー3件に対応し、バックアップ検査の見逃し2件と実機ケースの権限差の食い違いを直した | [review](../review/README.md) |
| 2026-09-12 | — | 端末に残す置き場がバックアップから除外されていることを走査する検査を置いた | — |
| 2026-09-12 | — | 権限除去後の生成・連続10分観測・機内モードを実機確認し、モデルDLだけを確認待ちに残した | [review](../review/README.md) |
| 2026-09-12 | — | Fable 5.1 の AI 設計章を課題枠と突合し、処遇6件と依存を上げる契機を書いた | [dependency_policy](system/dependency_policy.md) |
| 2026-09-12 | — | プライバシー対応をレビューし、権限除去と増減検査を机上確認して実機待ちを維持した | [review](../review/README.md) |
| 2026-09-12 | — | 推移依存が持ち込むネットワーク権限2件を除き、マージ後マニフェストの権限を数える検査を置いた | [dependency_policy](system/dependency_policy.md) |
| 2026-09-12 | — | 文書レビュー3件の修正を確認し、冊子の文書課題と受付3行を閉じた | [review](../review/README.md) |
| 2026-09-12 | — | 文書レビュー3件に対応し、オフラインLintの誤断定を撤回して旧半回転の数値を外した | [review](../review/README.md) |
| 2026-09-12 | — | Fable 5.1 の文書対応をレビューし、規約・冊子仕様・Lint実測の不整合3件を受付した | [review](../review/README.md) |
| 2026-09-12 | — | 分野色と返事保存を実機確認し、実機待ち3件を閉じて再利用可能な検証ケースを追加した | [review](../review/README.md) |
| 2026-09-12 | — | Fable 5.1 の課題候補29件を検討する特別枠を `_wip` へ置いた（報告書本体はgit管理外） | [fable51_triage](../_wip/fable51_triage.md) |
...
| 2026-09-12 | — | architecture.md を全文突合し、窓口の行数と共通化しない表を実装へ揃えた | [architecture](system/architecture.md) |
