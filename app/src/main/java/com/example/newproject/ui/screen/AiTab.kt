...
fun AiTab(
    ...
    onDragDistillRangeEdge: (String, DistillRangeEdge, Int) -> Unit,
...
private fun DistillPanel(
    ...
    onDragRangeEdge: (String, DistillRangeEdge, Int) -> Unit,
    ...
    candidates?.rangeSheetItem?.let { item ->
        DistillRangeSheet(
            ...
            onDragEdge = { edge, offset -> onDragRangeEdge(item.id, edge, offset) },
